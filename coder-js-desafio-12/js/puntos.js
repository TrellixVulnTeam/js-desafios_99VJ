...
function checkDisableButtonsPuntos(){
    
  let puntosJugador = JSON.parse(localStorage.getItem('puntosJugador'));
  if (puntosJugador == 0){
    disableButton('btn-restar-puntos-jugador');
  }else{
    enableButton('btn-restar-puntos-jugador');
  }

  if (puntosJugador == 30){
    disableButton('btn-sumar-puntos-jugador');
  }else{
    enableButton('btn-sumar-puntos-jugador');
  }
  
  let puntosPC = JSON.parse(localStorage.getItem('puntosPC'));

  if (puntosPC == 0){
    disableButton('btn-restar-puntos-pc');
  }else{
    enableButton('btn-restar-puntos-pc');
  }
